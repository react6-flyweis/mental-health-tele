...
export default function RefundsHero() {
  return (
    <section className="py-20 bg-[#F6FFFC] relative overflow-hidden">
      ...
      <div className="text-center max-w-3xl mx-auto px-4">
        ...
        <h1 className="text-4xl md:text-5xl max-w-lg font-semibold tracking-tight mt-2 mx-auto">
          <span className="text-primary">Refunds &amp; Fees</span> Policy
        </h1>

        <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
          This policy explains when refunds may be issued and what fees apply
          for appointment cancellations, rescheduling, or missed visits.
        </p>
