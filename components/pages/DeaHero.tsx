...
export default function DeaHero() {
  return (
    <section className="py-16 bg-[#F3FEFB] relative">
      ...
      <div className="text-center max-w-3xl mx-auto px-4">
        ...
        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight mt-2">
          <span className="text-primary block">Telehealth Prescription</span>
          <span className="text-primary block">Law Update</span>
        </h1>

        <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
          Everything you need to know about online prescriptions and the latest
          regulations
        </p>
      </div>
    </section>
