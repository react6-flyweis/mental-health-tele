...
export default function PaymentTermsHero() {
  return (
    <section className="py-20 bg-[#F6FFFC] relative overflow-hidden">
      ...
      <div className="text-center max-w-3xl mx-auto px-4">
        ...
        <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
          This page explains how payments are processed when you use our
          services. Please review these terms carefully before making any
          payment.
        </p>
      </div>
    </section>
