...
import depressionImg from "@/assets/conditions/depression.png";
...
export default function DepressionHero() {
  const features = [
    ...
    {
      id: "prescriptions",
      title: "Digital prescriptions when appropriate",
      icon: FileTextIcon,
    },
  ];
            ...
            <div className="md:col-span-6">
              <h1 className="text-4xl md:text-5xl font-semibold tracking-tight leading-tight">
                <span className="block text-primary">
                  ...
                  <span className="text-slate-900">When You Need</span>
                </span>
              </h1>
            ...
            <div className="md:col-span-6 flex justify-center md:justify-end">
              <div className="relative w-full max-w-md">
                <div className="rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src={depressionImg}
                    alt="Person relaxing on a sofa with a laptop"
                    width={940}
                    height={620}
