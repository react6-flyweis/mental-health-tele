    ...
    <section className="p-10">
      <div className="py-10 bg-accent rounded-2xl relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-5 gap-6 max-w-6xl mx-auto px-4">
            {categories.map((c) => (
              <div
                key={c.name}
                className="relative overflow-hidden rounded-2xl bg-[#E2EBEC] p-6 flex flex-col items-center gap-4 text-center hover:shadow-lg transition-all duration-300"
              >
                {/* absoulte circle at top left corner */}
